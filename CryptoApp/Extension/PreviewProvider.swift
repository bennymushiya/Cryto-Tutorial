...
class DeveloperPreview {
    ...
    // creates a single instance of our preview that where gonna use throughout our entire app
    static let instance = DeveloperPreview()
    
    // we make it private becasue we dont want somewhere else in our code for this to be initiailised then we would have 2 instances of developer preview, but with this we only have a single instance being initialised
    private init() { }
    
    // now we have access to the homeViewModel to use in our previews 
